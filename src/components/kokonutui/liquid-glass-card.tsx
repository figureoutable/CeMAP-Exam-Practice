...
const liquidButtonVariants = cva("relative transition-colors duration-200", {
  variants: {
    liquidVariant: {
      default: "",
      none: "",
...
export type LiquidButtonProps = ButtonPrimitive.Props &
...
function LiquidButton({
  ...
  return (
    <Button
      className={cn(
        liquidButtonVariants({ liquidVariant }),
        "shadow-none",
        className
      )}
      {...props}
...
const liquidGlassCardVariants = cva(
  "group relative overflow-hidden bg-white transition-colors",
  {
    variants: {
      glassSize: {
        sm: "p-3",
  ...
  return (
    <Card
      className={cn(
        ...
        "border border-blue-200 shadow-none",
        className
      )}
      {...props}
    >
